...
$ac_post_arr = [];
$ac_get_arr = ['recruitment_list' => '招聘列表', 'recruitment_details' => '招聘详情'];
// 当前操作
$ac = $_REQUEST['a'];
...
if ($ac == 'recruitment_list') {
    ...
    // 是否收藏
    $data['is_collect'] = is_user_login() ? $db->row_count('member_collect',"type='activity' and data_id={$_GET['id']} and user_id={$_SESSION['USER_ID']}") : 0;
