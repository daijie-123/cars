...
elseif ($ac == 'add' || $ac == 'edit')
{
    ...
    else
    {
        ...
        $select_experience = select_make($data['experience'], [0 => '不限', 1 => '1年以下', 2 => '1-3年', 3 => '3-5年', 4 => '5-10年', 5 => '10年以上'], "请选择工作经验");

        $select_education = select_make($data['education'], [0 => '不限', 1 => '不限', 2 => '初中', 3 => '中技', 4 => '高中', 5 => '中专', 6 => '大专', 7 => '本科', 8 => '硕士', 9 => '博士'], "请选择学历要求");
