...
<div class="sidebar">
	...
	<ul class="hide">
		<li><a href="<?php echo WEB_PATH?>?m=activity&a=list" target="report_iframe">活动管理</a></li>
...
<div class="sidebar">
	...
	<ul class="hide">
        ...
        <li><a href="<?php echo WEB_PATH?>?m=agency_service&a=list" target="report_iframe">车管服务</a></li>
